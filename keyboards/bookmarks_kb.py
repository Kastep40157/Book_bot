...
def create_bookmarks_keyboard(*args:int)->InlineKeyboardMarkup:
    ...
    for button in sorted(args):
        ...
        kb_builder.row(InlineKeyboardButton(text=LEXICON['edit_bookmarks_button'],callback_data='edit_bookmarks'),InlineKeyboardButton(text=LEXICON['cancel'],callback_data='cancel'), width=2)
